...
<html lang="en">
	<head>
		...
		<meta name="description" content="DBEXAMES" />
			...
			<div class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-inner">
					<div class="container">
						...
						<a class="brand" href="./">EXAMES MÉDICOS</a>
						<div class="nav-collapse collapse">
							<ul class="nav">
								<li <?php if ($this->nav=='agendas') { echo 'class="active"'; } ?>><a href="./agendas">Agendas</a></li>
							...
							<ul class="nav pull-right">
								...
								<li><a href="./secureadmin">LOGAR <i class="icon-lock"></i></a></li>
