...
var page = {
	...
	updateModel: function() {
		...
		page.agenda.save({
			'datahora': $('input#datahora').val()+' '+$('input#datahora-time').val(),
			'nome': $('input#nome').val(),
			'idexame': $('input#idexame').val(),
			'idpaciente': $('input#idpaciente').val(),
			'obs': $('textarea#obs').val(),
			'resultado': $('textarea#resultado').val()
		}, {
			wait: true,
			success: function(){
				$('#agendaDetailDialog').modal('hide');
				setTimeout("app.appendAlert('Agenda was sucessfully " + (isNew ? "inserted" : "updated") + "','alert-success',3000,'collectionAlert')",500);
				app.hideProgress('modelLoader');
	...
	deleteModel: function()	{
		...
		page.agenda.destroy({
			...
			success: function(){
				$('#agendaDetailDialog').modal('hide');
				setTimeout("app.appendAlert('The Agenda record was deleted','alert-success',3000,'collectionAlert')",500);
				app.hideProgress('modelLoader');
